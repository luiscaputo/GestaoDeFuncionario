//Metod post para consumir api
var retorno;


const methodPost = async (obj, Url) => {
...
//Metodo get para consumir api

const CarregarDdaos = async (Url) => {
  const res = await axios({
    method: 'get',
    url: Url,
  });
...
//Pegar o valor da minha txt
var valor_da_txt = (nome) => document.querySelector('[name='+nome +']').value;
